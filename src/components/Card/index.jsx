...
export default function Card({ name, icon, rating, minDeposit, methods, bonus, link }) {
    return (
        <div className="w-full bg-[#18202F] justify-between border border-[#FFD700] rounded-[12px] xl:p-8 p-4 flex flex-col gap-5 transform hover:scale-105 transition-all duration-300 relative overflow-hidden">
            {/* Card Icon (Logo Link) */}
